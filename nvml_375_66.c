...
nvmlReturn_t DECLDIR nvmlDeviceGetP2PStatus(nvmlDevice_t device1, nvmlDevice_t device2, nvmlGpuP2PCapsIndex_t p2pIndex,nvmlGpuP2PStatus_t *p2pStatus){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device1, nvmlDevice_t device2, nvmlGpuP2PCapsIndex_t p2pIndex,nvmlGpuP2PStatus_t *p2pStatus);fn = getfn("nvmlDeviceGetP2PStatus");ret=fn(device1, device2, p2pIndex,p2pStatus);return ret;}


nvmlReturn_t DECLDIR nvmlDeviceGetBoardPartNumber(nvmlDevice_t device, char* partNumber, unsigned int length){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, char* partNumber, unsigned int length);fn = getfn("nvmlDeviceGetBoardPartNumber");ret=fn(device, partNumber, length);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceGetClock(nvmlDevice_t device, nvmlClockType_t clockType, nvmlClockId_t clockId, unsigned int *clockMHz){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, nvmlClockType_t clockType, nvmlClockId_t clockId, unsigned int *clockMHz);fn = getfn("nvmlDeviceGetClock");ret=fn(device, clockType, clockId, clockMHz);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceGetMaxCustomerBoostClock(nvmlDevice_t device, nvmlClockType_t clockType, unsigned int *clockMHz){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, nvmlClockType_t clockType, unsigned int *clockMHz);fn = getfn("nvmlDeviceGetMaxCustomerBoostClock");ret=fn(device, clockType, clockMHz);return ret;}


nvmlReturn_t DECLDIR nvmlDeviceGetNvLinkState(nvmlDevice_t device, unsigned int link, nvmlEnableState_t *isActive){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, unsigned int link, nvmlEnableState_t *isActive);fn = getfn("nvmlDeviceGetNvLinkState");ret=fn(device, link, isActive);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceGetNvLinkVersion(nvmlDevice_t device, unsigned int link, unsigned int *version){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, unsigned int link, unsigned int *version);fn = getfn("nvmlDeviceGetNvLinkVersion");ret=fn(device, link, version);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceGetNvLinkCapability(nvmlDevice_t device, unsigned int link, nvmlNvLinkCapability_t capability, unsigned int *capResult){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, unsigned int link, nvmlNvLinkCapability_t capability, unsigned int *capResult);fn = getfn("nvmlDeviceGetNvLinkCapability");ret=fn(device, link, capability, capResult);return ret;} 

nvmlReturn_t DECLDIR nvmlDeviceGetNvLinkRemotePciInfo(nvmlDevice_t device, unsigned int link, nvmlPciInfo_t *pci){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, unsigned int link, nvmlPciInfo_t *pci);fn = getfn("nvmlDeviceGetNvLinkRemotePciInfo");ret=fn(device, link, pci);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceGetNvLinkErrorCounter(nvmlDevice_t device, unsigned int link, nvmlNvLinkErrorCounter_t counter, unsigned long long *counterValue){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, unsigned int link, nvmlNvLinkErrorCounter_t counter, unsigned long long *counterValue);fn = getfn("nvmlDeviceGetNvLinkErrorCounter");ret=fn(device, link, counter, counterValue);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceResetNvLinkErrorCounters(nvmlDevice_t device, unsigned int link){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, unsigned int link);fn = getfn("nvmlDeviceResetNvLinkErrorCounters");ret=fn(device, link);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceSetNvLinkUtilizationControl(nvmlDevice_t device, unsigned int link, unsigned int counter, nvmlNvLinkUtilizationControl_t *control, unsigned int reset){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, unsigned int link, unsigned int counter, nvmlNvLinkUtilizationControl_t *control, unsigned int reset);fn = getfn("nvmlDeviceSetNvLinkUtilizationControl");ret=fn(device, link, counter, control, reset);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceGetNvLinkUtilizationControl(nvmlDevice_t device, unsigned int link, unsigned int counter, nvmlNvLinkUtilizationControl_t *control){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, unsigned int link, unsigned int counter, nvmlNvLinkUtilizationControl_t *control);fn = getfn("nvmlDeviceGetNvLinkUtilizationControl");ret=fn(device, link, counter, control);return ret;}


nvmlReturn_t DECLDIR nvmlDeviceGetNvLinkUtilizationCounter(nvmlDevice_t device, unsigned int link, unsigned int counter,  unsigned long long *rxcounter, unsigned long long *txcounter){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, unsigned int link, unsigned int counter,  unsigned long long *rxcounter, unsigned long long *txcounter);fn = getfn("nvmlDeviceGetNvLinkUtilizationCounter");ret=fn(device, link, counter,  rxcounter, txcounter);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceFreezeNvLinkUtilizationCounter(nvmlDevice_t device, unsigned int link,  unsigned int counter, nvmlEnableState_t freeze){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, unsigned int link,  unsigned int counter, nvmlEnableState_t freeze);fn = getfn("nvmlDeviceFreezeNvLinkUtilizationCounter");ret=fn(device, link,  counter, freeze);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceResetNvLinkUtilizationCounter(nvmlDevice_t device, unsigned int link, unsigned int counter){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlDevice_t device, unsigned int link, unsigned int counter);fn = getfn("nvmlDeviceResetNvLinkUtilizationCounter");ret=fn(device, link, counter);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceModifyDrainState(nvmlPciInfo_t *pciInfo, nvmlEnableState_t newState){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlPciInfo_t *pciInfo, nvmlEnableState_t newState);fn = getfn("nvmlDeviceModifyDrainState");ret=fn(pciInfo, newState);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceQueryDrainState(nvmlPciInfo_t *pciInfo, nvmlEnableState_t *currentState){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlPciInfo_t *pciInfo, nvmlEnableState_t *currentState);fn = getfn("nvmlDeviceQueryDrainState");ret=fn(pciInfo, currentState);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceRemoveGpu(nvmlPciInfo_t *pciInfo){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlPciInfo_t *pciInfo);fn = getfn("nvmlDeviceRemoveGpu");ret=fn(pciInfo);return ret;}

nvmlReturn_t DECLDIR nvmlDeviceDiscoverGpus(nvmlPciInfo_t *pciInfo){nvmlReturn_t ret;nvmlReturn_t DECLDIR (*fn)(nvmlPciInfo_t *pciInfo);fn = getfn("nvmlDeviceDiscoverGpus");ret=fn(pciInfo);return ret;}
